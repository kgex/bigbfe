          ...
          <Grid container spacing={9}>
            <Grid item xs="auto" width="fit-content">
              <Card sx={{ boxShadow: 10, width: "20pc" }} xs={6}>
                <CardMedia component="img" height="180" image={props.Img} alt="green iguana" />
            ...
            <Grid item xs="auto" container direction="column" justifyContent="space-evenly">
              <TextField id="outlined-basic" label="Project Name" />
              <br />
              <TextField id="outlined-basic" label="No Persons" />
              <br />
            </Grid>
            <Grid item xs="auto" container direction="column" justifyContent="space-evenly">
              <TextField id="outlined-multiline-flexible" label="Name's" multiline maxRows={4} />
              <br />
              <TextField
